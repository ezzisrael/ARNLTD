      ...
      <div className="container grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div>
          <h2 className="text-2xl md:text-3xl font-bold">
            National Stadium Renovation, Lagos
          </h2>
          <p className="mt-4 text-gray-600 leading-relaxed">
            Aron Nigeria Limited delivered a state-of-the-art upgrade to
            Nigeria’s premier sports facility, ensuring international standards
            and long-term sustainability. Our integrated design and execution
            teams completed the works with zero lost-time incidents.
          </p>
          <a
            href="/projects"
